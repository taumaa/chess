...
namespace ImGui
{
    ...
    IMGUI_API void          SetNextWindowToFront();                                                     // set next window to be top-most. call before Begin()
    ...
    IMGUI_API void          SetWindowToFront();                                                         // (not recommended) set current window to be top-most. prefer using SetNextWindowToFront().
    ...
    IMGUI_API bool          Button(const char* label, const ImVec2& size = ImVec2(0, 0), ImDrawFlags draw_flags = 0); // button
    ...
    IMGUI_API bool          BeginCombo(const char* label, const char* preview_value, ImGuiComboFlags flags = 0, ImDrawFlags draw_flags = 0);
    ...
    typedef void (*CustomParser)(const char*, void*);
    IMGUI_API bool          DragFloat(const char* label, float* v, float v_speed = 1.0f, float v_min = 0.0f, float v_max = 0.0f, const char* format = "%.3f", ImGuiSliderFlags flags = 0, CustomParser custom_parser = nullptr);     // If v_min >= v_max we have no bound
    ...
    IMGUI_API bool          DragScalar(const char* label, ImGuiDataType data_type, void* p_data, float v_speed = 1.0f, const void* p_min = NULL, const void* p_max = NULL, const char* format = NULL, ImGuiSliderFlags flags = 0, CustomParser custom_parser = nullptr);
    ...
    IMGUI_API bool          InputText(const char* label, char* buf, size_t buf_size, ImGuiInputTextFlags flags = 0, ImGuiInputTextCallback callback = NULL, void* user_data = NULL, ImDrawFlags draw_flags = 0);
    IMGUI_API bool          InputTextMultiline(const char* label, char* buf, size_t buf_size, const ImVec2& size = ImVec2(0, 0), ImGuiInputTextFlags flags = 0, ImGuiInputTextCallback callback = NULL, void* user_data = NULL);
    IMGUI_API bool          InputTextWithHint(const char* label, const char* hint, char* buf, size_t buf_size, ImGuiInputTextFlags flags = 0, ImGuiInputTextCallback callback = NULL, void* user_data = NULL);
    IMGUI_API bool          InputFloat(const char* label, float* v, float step = 0.0f, float step_fast = 0.0f, const char* format = "%.3f", ImGuiInputTextFlags flags = 0, ImDrawFlags draw_flags = 0);
    ...
    IMGUI_API bool          InputScalar(const char* label, ImGuiDataType data_type, void* p_data, const void* p_step = NULL, const void* p_step_fast = NULL, const char* format = NULL, ImGuiInputTextFlags flags = 0, ImDrawFlags draw_flags = 0, CustomParser custom_parser = nullptr);
    ...
    IMGUI_API bool          BeginMenu(const char* label, bool enabled = true, float arrow_offset_y = 0.f); // create a sub-menu entry. only call EndMenu() if this returns true!
    ...
    IMGUI_API bool          BeginPopupContextItem(const void* ptr_id, ImGuiPopupFlags popup_flags = 1);  // open+begin popup when clicked on last item.
