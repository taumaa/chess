...
enum ImGuiNextWindowDataFlags_
{
    ...
    ImGuiNextWindowDataFlags_BringToFront       = 1 << 12
};
...
struct ImGuiContext
{
    ...
    float window_title_height_bias = 0.f; // HACK(JF) To fix the computation of Window::TitleBarHeight() when using a different font / padding for the window titles than for the rest of the UI.
...
public:
    ...
    float       TitleBarHeight() const  { ImGuiContext& g = *Ctx; return (Flags & ImGuiWindowFlags_NoTitleBar) ? 0.0f : CalcFontSize() + g.Style.FramePadding.y * 2.0f + g.window_title_height_bias; }
...
//#endif
    ...
    IMGUI_API bool          BeginMenuEx(const char* label, const char* icon, bool enabled = true, float arrow_offset_y = 0.f);
    ...
    IMGUI_API void          RenderFrame(ImVec2 p_min, ImVec2 p_max, ImU32 fill_col, bool border = true, float rounding = 0.0f, ImDrawFlags draw_flags = 0);
    ...
    IMGUI_API bool          ButtonEx(const char* label, const ImVec2& size_arg = ImVec2(0, 0), ImGuiButtonFlags flags = 0, ImDrawFlags draw_flags = 0);
    ...
    IMGUI_API bool          CloseButton(ImGuiID id, const ImVec2& pos, float height = -1.f, bool tweak_for_tab_bar = false);
    IMGUI_API bool          CollapseButton(ImGuiID id, const ImVec2& pos, ImGuiDockNode* dock_node, float height = -1.f);
    ...
    template<typename T, typename SIGNED_T, typename FLOAT_T>   IMGUI_API bool  DragBehaviorT(ImGuiDataType data_type, T* v, float v_speed, T v_min, T v_max, const char* format, ImGuiSliderFlags flags, bool invert_drag_direction = false);
    ...
    IMGUI_API bool          DataTypeApplyFromText(const char* buf, ImGuiDataType data_type, void* p_data, const char* format, CustomParser custom_parser = nullptr);
    IMGUI_API int           DataTypeCompare(ImGuiDataType data_type, const void* arg_1, const void* arg_2);
    IMGUI_API bool          DataTypeClamp(ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max);

    // InputText
    IMGUI_API bool          InputTextEx(const char* label, const char* hint, char* buf, int buf_size, const ImVec2& size_arg, ImGuiInputTextFlags flags, ImGuiInputTextCallback callback = NULL, void* user_data = NULL, ImDrawFlags draw_flags = 0);
    IMGUI_API void          InputTextDeactivateHook(ImGuiID id);
    IMGUI_API bool          TempInputText(const ImRect& bb, ImGuiID id, const char* label, char* buf, int buf_size, ImGuiInputTextFlags flags);
    IMGUI_API bool          TempInputScalar(const ImRect& bb, ImGuiID id, const char* label, ImGuiDataType data_type, void* p_data, const char* format, const void* p_clamp_min = NULL, const void* p_clamp_max = NULL, CustomParser custom_parser = nullptr);
